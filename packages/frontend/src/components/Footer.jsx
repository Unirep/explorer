...
export default () => {
    return (
        <div className="footer flex" style={{backgroundImage: `url(${Background})`}}>
            <div className="flex">
                <a href="https://developer.unirep.io/" target='blank' style={{marginRight: "2em"}}>Docs</a>
                <a href="https://discord.com/invite/VzMMDJmYc5" target='blank'>Support</a>
            </div>
            <img src={require('../../public/logo.svg')} alt="UniRep logo"/>
            <div className="flex">
                <a href="https://github.com/Unirep" target='blank' style={{marginRight: "2em"}}><img src={require('../../public/github.svg')} alt="GitHub logo"/></a>
